...
// Logo avatar — used in chat bubbles and header
...
function BuddyChatInner() {
    ...
    const streamBuddyOverSocket = useCallback(
        async (text: string, deviceId: string) => {
            ...
            if (!socket?.connected || !roomJoined || !rk) {
            ...
            await new Promise<void>((resolve) => {
                ...
                function onErr(p: {
                    ...
                    if (p.requestId !== undefined && p.requestId !== requestId)
                        return;
                    setMessages((prev) => [
                        ...prev,
                        {
                ...
                <div className="px-4 sm:px-6 py-3 border-t border-border bg-card">
                    <div className="max-w-3xl mx-auto flex items-end gap-2">
                        ...
                        <button
                            ...
                            disabled={
                                !input.trim() || isLoading || !historyReady
                            }
                    ...
                    <p className="max-w-3xl mx-auto text-[10px] text-muted-foreground/40 mt-2 text-center">
                        ShockPlan provides educational information only — not
                        financial advice.
                    </p>
                </div>
            </div>
